...
(function () {
  ...
  const DOC = {
    ...
    muM:    { title: 'Slurry viscosity (µm)', unit: 'cP', formula: 'Thomas (1965): µm = µl·(1 + 2.5·Cv + 10.05·Cv² + 0.00273·e^(16.6·Cv))',
      what: 'Apparent Newtonian viscosity of the suspension as a function of volumetric concentration. Piecewise by Cv band (<1%, <20%, <40%). Overridden when a value is entered by the user.', refs: ['thomas'] },
    ...
    f:      { title: 'Friction factor (f)', unit: '', formula: 'Chen (1979) explicit Colebrook; f = 64/Re if Re ≤ 2100',
      what: 'Darcy friction factor from the Chen explicit equation using relative roughness and Reynolds number (laminar branch below Re 2100).', refs: ['chen', 'darcy'] },
